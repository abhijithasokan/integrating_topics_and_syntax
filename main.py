...
@click.option("--delta", type=float, default=0.5)
@click.option("--num_iter", type=int, default=1000)
@click.option("--num_topics", type=int, default=20)
@click.option("--num_classes", type=int, default=15)
@click.option("--dataset", type=str, default="data")
